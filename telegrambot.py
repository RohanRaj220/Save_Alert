...
def compare_days(date1,date2):
    ...
    for i , j in zip(l,h):
        ...
        p=to/3600
        d=bo/3600
    return ("date1 consumption:", p ,"date2 consumption:", d ,"difference:", p-d)
#query-3
...
bot = telegram.Bot(token='6264793498:AAFFH3BgmwIcAo45N5iyf3c8ftnyxObZf00')
...
def help(update, context):
    ...
    /Allert Message - Gives an save allert message about the average limit
    '''
...
def pricing(update, context):
    ...
    try:
        ...
        return
    units=Today_energy_consumption(date)
...
updater = Updater(token='6264793498:AAFFH3BgmwIcAo45N5iyf3c8ftnyxObZf00', use_context=True)

# Get the dispatcher to register handlers
dispatcher = updater.dispatcher
dispatcher.add_handler(CommandHandler('start', start))
dispatcher.add_handler(CommandHandler('help', help))
dispatcher.add_handler(CommandHandler('Allert', Allert))
